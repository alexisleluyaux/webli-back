 ...
 */
package com.webliapi.servlet;

import com.webliapi.command.Command;
import com.webliapi.command.EnumToolsName;
 ...
 * @author steph
 */
@WebServlet(name = "APIServlet", urlPatterns = {"/webli/command"})
public class APIServlet extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            out.println("</head>");
            out.println("<body>");
            out.println("<h1>eror 400 bad request</h1>");
            out.println("</body>");
            out.println("</html>");
        }
    }
